'use strict';
const CACHE = 'flock-alt-v21';
const ASSETS = [
  'index.html','login.html','signup.html','onboarding.html',
  'home.html','flocks.html','roost.html','roosts.html','event.html','my-flocks.html','my-roosts.html','profile.html',
  ...
  'js/pages/home.js','js/pages/roost.js','js/pages/roosts.js','js/pages/flocks.js','js/pages/my-flocks.js','js/pages/event.js','js/pages/my-roosts.js',
  'js/pages/profile.js',
